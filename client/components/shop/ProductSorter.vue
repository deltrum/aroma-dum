        ...
        <ul class="sorter__list">
            <li class="sorter__item">
                <label class="sorter__label">
                    Rating
                    <input class="sorter__checkbox" type="checkbox" v-model="productSorterData.rating" />
                    <svg xmlns="http://www.w3.org/2000/svg" width="20.934" height="11.524" viewBox="0 0 20.934 11.524">
                        <path id="down-chevron" d="M19.846,91.567l-9.379,9.348L1.088,91.567,0,92.659l10.467,10.433L20.934,92.659Z" transform="translate(0 -91.567)" />
                    </svg>
                </label>
            </li>
            <li class="sorter__item">
